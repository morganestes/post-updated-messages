...
# main config
PLUGINSLUG='post-updated-messages' # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="post-updated-messages.php" # this should be the name of your main php file in the wordpress plugin
SVNUSER="morganestes" # your svn username (case sensitive)
